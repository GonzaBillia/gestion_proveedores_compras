...
def make_cost_comparation(db_df, provider_df):
    ...
    try:
        ...
        merged_df = pd.merge(db_df[["idproducto", "ean", "descripcion", "costo", "iva", "margen_pvp"]], provider_df[["idproducto", "precio_costo"]], on="idproducto", how="inner")
        
        # Seleccionar las columnas requeridas
        result_df = merged_df[["idproducto", "ean", "descripcion", "costo", "precio_costo", "iva", "margen_pvp"]]
