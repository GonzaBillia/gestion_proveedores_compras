...
def make_report(data_frame_array, update_ui_callback, req_filename_reporte, req_filename_costos, req_filename_maintance, req_path_callback):
    ...
    maintance_report = export_file_to_csv(maintance_report, dk_reports, req_filename_maintance, req_path_callback)
