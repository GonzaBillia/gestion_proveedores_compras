...
from libs.comparator.queries.queries import PORDUCTS_BY_PROVIDER
import logging

# Configurar el logger
logging.basicConfig(level=logging.INFO, format="%(asctime)s - %(levelname)s - %(message)s")

id_provider = 10064 #temp

def fetch_products_by_provider():
    """
    ...
    try:
        ...
        with connection.cursor() as cursor:
            ...
            cursor.execute(PORDUCTS_BY_PROVIDER, {'id_provider': id_provider})
        ...
        columns = ['IDProducto', 'ean', 'descripcion', 'Proveedor', 'IDLaboratorio']
